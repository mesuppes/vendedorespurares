...
<div class="wrapper ">
                        ...
                        <div class="col-md-12 pr-1 pl-1">
                            <div class="bg-white card card-user">
                                ...
                                <h5 class="card-title">Stock de productos</h5>
                                    ...
                                    <a  onclick="imprimirTabla();"
                                        class="btn btn-sm btn-warning ml-auto">Imprimir
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    var pdf= new jsPDF({orientation: 'p',
        ...
        var tablaParaImprimir=$("#tablaStock").clone();
...
const pageHeight = pdf.internal.pageSize.height;  //Optional
      ...
      pdf.setTextColor('#436784').setFont('Century Gothic').setFontStyle('bold').setFontSize(10).text(`${j} de ${pages}`, horizontalPos, verticalPos)
        ...
        pdf.setTextColor('#436784').setFont('Century Gothic').setFontStyle('bold').setFontSize(30).text(6,2,'Stock productos al '+fecha);
      pdf.setFontSize(10).text(170,25,"Página: ");
