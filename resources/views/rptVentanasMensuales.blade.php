...
<div class="wrapper ">
  ...
  function imprimirReporte(){
    ...
    var reporte= new jsPDF({orientation: 'l',
                                        unit: 'cm',
                                        format: 'a4'});
    	...
    	reporte.line(0.53, 2.9, 28.5, 2.9);

        var reporteParaImprimir=$("#tablaReporte").clone();


        var reporteJson=reporte.autoTableHtmlToJson(reporteParaImprimir.get(0))
